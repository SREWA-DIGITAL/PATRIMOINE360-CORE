...
import {
  barcodeTrialWelcomeEmailText,
  sendBarcodeTrialWelcomeEmail,
} from "./barcode-trial-welcome";

describe("barcodeTrialWelcomeEmailText", () => {
  it("includes firstName in greeting when provided", () => {
    const text = barcodeTrialWelcomeEmailText({
      firstName: "Alice",
...
describe("sendBarcodeTrialWelcomeEmail", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
